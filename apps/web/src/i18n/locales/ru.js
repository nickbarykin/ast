export const ru = {
  ...
  labels: {
    ...
    lblBack: 'Назад',
    lblForward: 'Вперед',
    lblPointGroup: 'Группа',
    lblRetrograde: 'Ретроградность',
    lblYes: 'Да',
    lblNo: 'Нет',
    lblFrom: 'От',
    lblTo: 'К',
    lblExactAngle: 'Точный угол',
    lblActualAngle: 'Фактический угол',
    lblOrb: 'Орбис',
    lblEffectiveOrb: 'Итоговый орбис',
    lblSize: 'Размер',
    lblContains: 'Содержит',
    lblSelectAll: 'Все',
